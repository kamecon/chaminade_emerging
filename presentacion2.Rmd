...
<img src="CompSpa2.jpg" width="800">
...
<img src="ExpSpain2.jpg" width="500">
...
<img src="ImpSpain2.jpg" width="450">
...
Tablas_prov <- Tablas %>%
  bind_cols() %>%
  select(-matches("^C.*[2-9]$")) #Empieza por C y acaba en digito. No seleccionar
...
colnames(Tablas_prov) <- c("Conceptos","Emerging Market and Middle-Income Economies","Major Advanced Economies - G7","Advanced Economies (IMF)","Emerging Market Latin America")
